...
const sprintCharts_1 = require("./sprintCharts");
...
assertEqual((0, sprintCharts_1.calculateReliabilityPct)(0, 14), null, "reliability is unavailable with no commitment");
assertDeepEqual((0, sprintCharts_1.calculateMovingAverage)([80, 90, 100, null, 70], 3), [null, null, 90, null, null], "moving average requires a full numeric window");
const normalizedScope = (0, sprintCharts_1.normalizeScopeChange)(metricsResponse().delivery_confidence);
assertDeepEqual(normalizedScope, {
    scope_change_count: 3,
    scope_creep_pct: 15,
    scope_added_count: 4,
    scope_removed_count: 1,
...
assertDeepEqual((0, sprintCharts_1.normalizeQualityTrend)(metricsResponse().metrics), {
    open_high_severity_bugs: 1,
    bugs_created_during_sprint: 2,
    reopen_rate_pct: 12,
}, "quality trend keeps available quality fields");
const history = (0, sprintCharts_1.buildSprintChartHistory)([
...
const partialHistory = (0, sprintCharts_1.buildSprintChartHistory)([
    {
        sprint_id: "partial",
        name: "Partial",
        is_not_closed: false,
...
const unavailableStoryPointHistory = (0, sprintCharts_1.buildSprintChartHistory)([
    {
        sprint_id: "no-points",
        name: "No points",
        is_not_closed: false,
