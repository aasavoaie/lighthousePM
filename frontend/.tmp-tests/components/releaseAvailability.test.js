...
const releaseAvailability_1 = require("./releaseAvailability");
...
const scoreDisplay = (0, releaseAvailability_1.getReleaseScoreDisplay)(noTicketMetrics);
...
const metricDisplay = (0, releaseAvailability_1.getReleaseMetricDisplay)(noTicketMetrics, "scope_completed_pct");
...
assertEqual((0, releaseAvailability_1.getReleaseChartEmptyMessage)(noTicketMetrics, noTicketCharts, "readiness_pct", "No readiness history available yet."), "No tickets are available for this scope.", "readiness chart empty state uses API reason when not computable");
