import { buildJiraConfigurationUpdate, type JiraSettingsForm } from "./jiraConfiguration";
...
const browserSave = buildJiraConfigurationUpdate(form, false);
...
const connectionTest = buildJiraConfigurationUpdate(form, true);
