...
chain is a supported upgrade source. With current head `20260727_0022`, this
means revisions `20260407_0001` through `20260726_0021`. Supported
...
```text
%APPDATA%\LighthousePM\data\lighthouse.db.pre-20260727_0022.bak
```
